...
class ManagerUsersFragment : Fragment(R.layout.fragment_manager_users) {
    ...
    override fun onCreateView(
        ...
        observeShowUserValidateToastEvent()
        observeShowFailedDeleteUserToastEvent()
    ...
    private fun observeShowUserValidateToastEvent() = viewModel.showUserValidateToastEvent.observeEvent(viewLifecycleOwner) {
        Toast.makeText(requireContext(), it, Toast.LENGTH_LONG)
    }

    private fun observeShowFailedDeleteUserToastEvent() = viewModel.showFailedDeleteUserToastEvent.observeEvent(viewLifecycleOwner) {
        Toast.makeText(requireContext(), it, Toast.LENGTH_LONG)
    }
