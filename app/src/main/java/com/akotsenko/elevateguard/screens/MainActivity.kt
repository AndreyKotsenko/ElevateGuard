...
class MainActivity : AppCompatActivity() {
    ...
    private val topLevelDestinations = setOf(getUserTabsDestination(), getSignInDestination(), getManagerTabsDestination())

    private val fragmentListener = object : FragmentManager.FragmentLifecycleCallbacks() {
        override fun onFragmentViewCreated(fm: FragmentManager, f: Fragment, v: View, savedInstanceState: Bundle?) {
            super.onFragmentViewCreated(fm, f, v, savedInstanceState)
            if (f is UserTabsFragment || f is NavHostFragment) return
    ...
    private fun isSignedIn(): Boolean {
        return viewModel.getIsSignedInState()
    }


    private fun getMainNavigationGraphId(): Int = R.navigation.main_graph

    private fun getUserTabsDestination(): Int = R.id.userTabsFragment

    private fun getSignInDestination(): Int = R.id.signInFragment

    private fun getManagerTabsDestination(): Int = R.id.managerTabsFragment
}